...
To inspect earlier threads for this project, call `pstack_sessions` with `action: "list"` and read only the returned thread IDs. Never scan another project's threads.
