...
Decompose the question into 2 to 4 exploration angles, each a distinct slice of the subsystem. Spawn all explorers in one parallel `subagent` call using its `tasks` array:
