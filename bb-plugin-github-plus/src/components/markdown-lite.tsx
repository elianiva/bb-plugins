import { isSafeExternalUrl } from "../app-logic.js";
...
type SafeUrlLinkProps = ComponentProps<typeof UrlLink>;

export function SafeUrlLink({
  href,
  children,
  className,
  ...props
  ...
  return (
    <UrlLink href={href} className={className} {...props}>
      {children}
    </UrlLink>
  );
}
